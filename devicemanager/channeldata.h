...
public:
     ...
     * \param value value of the sample
     */
    void setCompressionOverflow (int index, int value) {if (index < 32) _isCompressionOverflow[index] = value;}

    /*!
     * It returns whether the sample is a repeated one due to packet loss
     */
    bool* compressionOverflow () { return _isCompressionOverflow;}
...
private:
    ...
    /*!
     * \property ChannelData::_isCompressionOverflow
     *
     * Boolean to control if current packet has suffered from compression overflow
     */
    bool _isCompressionOverflow[32];
};
